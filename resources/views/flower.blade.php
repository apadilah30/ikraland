            ...
            <div class="col-12">
                ...
                <form class="d-flex justify-content-between gap-2" role="search">
                    <div class="search-input d-flex rounded-4 w-100">
                        ...
                        <input class="form-control border-0 fw-bolder fs-6 search-input py-3 rounded-end-4" type="search"
                            placeholder="Cari tanaman" aria-label="Search" />
                    </div>
                    <button class="btn btn-success px-4 rounded-4" type="submit">Cari</button>
                </form>
