<section id="scan-navbar" class="container z-2 d-none">

    <div class="row border-top mt-5 py-4 rounded-5 rounded-bottom-0 shadow-navigation px-1 bg-light fixed-bottom justify-content-center mx-1">
